...
export function EditForm({ map }: { map: Prisma.MapGetPayload<{}> }) {
    const [state, action, pending] = useActionState(editMap.bind(null, map.id), null);
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div className="max-w-sm">
                                    <div className="relative">
                                        <input defaultValue={state?.inputData.title || map.title} type="text" placeholder="Learn to program" className={clsx("input", "input-floating", state?.errors.title && "is-invalid", "peer")} id="title" name="title" />
                                ...
                                <div className="w-full sm:w-96">
                                    ...
                                    <textarea defaultValue={state?.inputData.description || map.description} name='description' className={clsx('textarea', state?.errors.description && 'is-invalid')} placeholder="Lorem ipsum" id="description"></textarea>
                                    <div className="label">
